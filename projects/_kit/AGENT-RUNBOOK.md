...
## Chokepoint discipline (applies whenever chokepoint=TRUE is set)
...
- Sanity check before finishing: if more than ~1 in 4 nodes is TRUE, you are over-flagging; retighten.
