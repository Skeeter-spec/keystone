# Agent runbook for projects/07-food-fertilizer
...
stage candidate edges in `data/_incoming/edges_*.csv`, then run `tools/verify_edges.py projects/07-food-fertilizer`,
