# Agent runbook for projects/08-payment-rails
...
stage candidate edges in `data/_incoming/edges_*.csv`, then run `tools/verify_edges.py projects/08-payment-rails`,
