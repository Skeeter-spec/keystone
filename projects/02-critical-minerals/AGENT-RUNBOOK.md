# Agent runbook for projects/02-critical-minerals
...
stage candidate edges in `data/_incoming/edges_*.csv`, then run `tools/verify_edges.py projects/02-critical-minerals`,
